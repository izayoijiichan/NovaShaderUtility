...
namespace Izayoi.NovaShader.Extensions
{
    ...
    public static class MaterialExtension
    {
        ...
        public static Texture2D? GetSafeTexture(this Material material, int propertyNameId)
        {
            ...
            if (material.HasProperty(propertyNameId))
            {
                return material.GetTexture(propertyNameId) as Texture2D;
            }
#endif
            else
            {
        ...
        /// <param name="propertyNameId">A material property name ID.</param>
        /// <returns></returns>
        public static Texture2DArray? GetSafeTexture2DArray(this Material material, int propertyNameId)
        {
#if UNITY_2021_2_OR_NEWER
            if (material.HasTexture(propertyNameId))
            {
            ...
            if (material.HasProperty(propertyNameId))
            {
                return material.GetTexture(propertyNameId) as Texture2DArray;
            }
#endif
            else
            {
        ...
        /// <param name="propertyName">A material property name.</param>
        /// <returns></returns>
        public static Texture2DArray? GetSafeTexture2DArray(this Material material, string propertyName)
        {
#if UNITY_2021_2_OR_NEWER
            if (material.HasTexture(propertyName))
            {
            ...
            if (material.HasProperty(propertyName))
            {
                return material.GetTexture(propertyName) as Texture2DArray;
            }
#endif
            else
            {
        ...
        /// <param name="propertyNameId">A material property name ID.</param>
        /// <returns></returns>
        public static Texture3D? GetSafeTexture3D(this Material material, int propertyNameId)
        {
#if UNITY_2021_2_OR_NEWER
            if (material.HasTexture(propertyNameId))
            {
            ...
            if (material.HasProperty(propertyNameId))
            {
                return material.GetTexture(propertyNameId) as Texture3D;
            }
#endif
            else
            {
        ...
        /// <param name="propertyName">A material property name.</param>
        /// <returns></returns>
        public static Texture3D? GetSafeTexture3D(this Material material, string propertyName)
        {
#if UNITY_2021_2_OR_NEWER
            if (material.HasTexture(propertyName))
            {
            ...
            if (material.HasProperty(propertyName))
            {
                return material.GetTexture(propertyName) as Texture3D;
            }
#endif
            else
            {
        ...
        /// <param name="texture"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, int propertyNameId, Texture2DArray? texture)
        {
            if (material.HasProperty(propertyNameId))
            {
                material.SetTexture(propertyNameId, texture);
        ...
        /// <param name="textureScale"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, int propertyNameId, Texture2DArray? texture, Vector2 textureOffset, Vector2 textureScale)
        {
            if (material.HasProperty(propertyNameId))
            {
                material.SetTexture(propertyNameId, texture);
        ...
        /// <param name="texture"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, string propertyName, Texture2DArray? texture)
        {
            if (material.HasProperty(propertyName))
            {
                material.SetTexture(propertyName, texture);
        ...
        /// <param name="textureScale"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, string propertyName, Texture2DArray? texture, Vector2 textureOffset, Vector2 textureScale)
        {
            if (material.HasProperty(propertyName))
            {
                material.SetTexture(propertyName, texture);
        ...
        /// <param name="texture"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, int propertyNameId, Texture3D? texture)
        {
            if (material.HasProperty(propertyNameId))
            {
                material.SetTexture(propertyNameId, texture);
        ...
        /// <param name="textureScale"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, int propertyNameId, Texture3D? texture, Vector2 textureOffset, Vector2 textureScale)
        {
            if (material.HasProperty(propertyNameId))
            {
                material.SetTexture(propertyNameId, texture);
        ...
        /// <param name="texture"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, string propertyName, Texture3D? texture)
        {
            if (material.HasProperty(propertyName))
            {
                material.SetTexture(propertyName, texture);
        ...
        /// <param name="textureScale"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeTexture(this Material material, string propertyName, Texture3D? texture, Vector2 textureOffset, Vector2 textureScale)
        {
            if (material.HasProperty(propertyName))
            {
                material.SetTexture(propertyName, texture);
